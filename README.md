...
**R Version**: Requires R >= 4.2.0. The package supports the latest release version of R, as well as the previous four minor release versions. For example, if the latest release R version is 4.6, then versions 4.6, 4.5, 4.4, 4.3, and 4.2 are supported.
