...
test_that("calculate_connect_daily_user_counts works with basic data", {
  # Create sample data
  ...
  result <- calculate_connect_daily_user_counts(test_data)
...
test_that("calculate_connect_daily_user_counts handles locked users correctly", {
  test_data <- data.frame(
...
test_that("calculate_connect_daily_user_counts filters out inactive users (>1 year)", {
...
test_that("calculate_connect_daily_user_counts counts publishers and admins correctly", {
  test_data <- data.frame(
    date = as.Date("2024-01-01"),
    timestamp = as.POSIXct("2024-01-01 10:00:00"),
...
test_that("calculate_connect_daily_user_counts handles multiple timestamps per user per day", {
  test_data <- data.frame(
    date = as.Date("2024-01-01"),
    timestamp = as.POSIXct(c(
      "2024-01-01 09:00:00",
...
test_that("calculate_connect_daily_user_counts handles empty data", {
  test_data <- data.frame(
...
test_that("calculate_connect_daily_user_counts sorts results by date", {
  test_data <- data.frame(
